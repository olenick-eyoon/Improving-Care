...
public class ReportGeneratorTest {
    ...
    public void addHeader() {
        ...
        assertNotEquals(
                reportGenerator.getContent(),
                "Computer Name;Date and Time;Login Page;iCare1 Page;iCare2 Page;Scenario Name;Overview;Composite;Side By Side;Demographics;PDFGeneration;");
    }
    ...
    public void createWriter() throws FileNotFoundException,
        ...
        ReportGenerator reportGenerator = new ReportGenerator();
        PrintWriter writer = reportGenerator
                .createWriter("./resources/test.csv");
        assertNotNull(writer);
    }

    @Test
    public void printLineToFile() throws FileNotFoundException,
            UnsupportedEncodingException {
        ReportGenerator reportGenerator = new ReportGenerator();
        PrintWriter writer = reportGenerator
                .createWriter("./resources/test1.csv");
