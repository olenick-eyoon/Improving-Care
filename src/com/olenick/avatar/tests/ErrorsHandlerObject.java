...
public class ErrorsHandlerObject {
	...
	public void setScreenshotFolder() {
		errorHandler.setParentFolder(".\\resources\\errors");
		errorHandler.setScreenshotsFolder(errorHandler.getParentFolder() + "\\screenshots");
	...
	public void getScreenshotFolder() {
		errorHandler.setParentFolder(".\\resources\\errors");
		errorHandler.setScreenshotsFolder(errorHandler.getParentFolder() + "\\screenshots");
		assertEquals(errorHandler.getScreenshotsFolder(), ".\\resources\\errors\\screenshots");
	}
