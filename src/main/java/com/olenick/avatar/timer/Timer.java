...
@Deprecated
public class Timer {
    long loginTime, ic1Time, ic2Time, overviewTime, compositeTime,
            sideBySideTime, demographicsTime, exportCompositeTime,
            exportSideBySideTime, exportDemographicsTime;
