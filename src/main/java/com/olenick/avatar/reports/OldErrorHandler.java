...
public class OldErrorHandler {
     ...
     */
    public OldErrorHandler setComputerName(String computerName) {
     ...
     */
    public OldErrorHandler setScenario(String scenario) {
     ...
     */
    public OldErrorHandler setErrorTimeStamp(String errorTimeStamp) {
     ...
     */
    public OldErrorHandler setScreenshotsFolder(String screenshotsFolder) {
     ...
     */
    public OldErrorHandler setLogsFolder(String logsFolder) {
     ...
     */
    public OldErrorHandler setParentFolder(String parentFolder) {
        this.parentFolder = parentFolder;
        return this;
    }

    public OldErrorHandler initializeLog(String[] args)
    ...
    public OldErrorHandler addEventToLog(boolean noSuchElement,
    ...
    public OldErrorHandler initializePaths() {
