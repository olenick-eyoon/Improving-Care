...
public class ErrorHandler {
	...
	public ErrorHandler initializeLog(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		errorLog = new PrintWriter(
				"./resources/errors/logs/ERROR_" 
						+ computerName + "_" 
						+ args[0].replace(".xml", "") + "_" 
						+ errorTimeStamp 
						+ ".log", "UTF-8");
		return this;
	}

	public ErrorHandler addEventToLog(boolean noSuchElement, boolean elementNotAttached, boolean otherException, Exception e) {
		...
		if (elementNotAttached) {
 	        errorLog.println(errorTimeStamp + " ELEMENT NO LONGER ATTACHED TO THE DOM.");
		}
	...
	public void takeScreenshot(WebDriver driver) throws IOException {
		outputScreenshot = new File(screenshotsFolder + "screenshot_" + errorTimeStamp + ".png");
		FileUtils.copyFile(((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE), outputScreenshot);
	}
